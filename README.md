...
- فرم «ثبت پروژه» بدون بک‌اند کار می‌کند: اطلاعات را به‌صورت یک پیام آماده در **واتساپ ماهیر**
  باز می‌کند و کاربر را به صفحه‌ی تشکر می‌برد (شماره در `src/data/contact.ts`).
