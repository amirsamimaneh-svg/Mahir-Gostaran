      ...
      <div className="max-w-6xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-5"
            ...
            <span className="text-xs text-[#A89BFF] tracking-widest">
          ...
          <h1 className="font-extrabold mb-4" style={{ fontSize: "clamp(2rem,5vw,3.5rem)", color: "#f0f0f5" }}>
            ...
            <span style={{ background: "linear-gradient(135deg,#7C6FFF,#6A5EE8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-10">
          <button
            ...
            style={{
              background: !active ? "#7C6FFF" : "rgba(255,255,255,0.06)",
          ...
          {categories.map(cat => (
            <button key={cat} onClick={() => setActive(cat)}
              className="px-4 py-1.5 rounded-full text-xs font-bold transition-all"
              style={{
                background: active === cat ? "#7C6FFF" : "rgba(255,255,255,0.06)",
