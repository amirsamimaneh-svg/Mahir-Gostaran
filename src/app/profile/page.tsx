    ...
    <div dir="rtl" className="min-h-screen" style={{ background: "#05050f", color: "#f0f0f5" }}>
      ...
      <nav style={{ background: "rgba(5,5,15,0.9)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}
        ...
        <div className="max-w-3xl mx-auto flex items-center justify-between px-6 py-4">
          <Link href="/" className="text-xl font-extrabold text-amber-400 tracking-widest">ماهیر</Link>
        ...
        {tab === "chat" && (
          <div className="flex flex-col">
            <div className="rounded-2xl overflow-hidden mb-4" style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
              <div className="px-4 py-3 text-xs" style={{ background: "rgba(251,191,36,0.07)", borderBottom: "1px solid rgba(255,255,255,0.06)", color: "rgba(240,240,245,0.5)" }}>
                ...
                {messages.length === 0 ? (
                  ...
                  <div key={msg.id} className={`flex ${msg.from === "user" ? "justify-start" : "justify-end"}`}>
                    <div className="max-w-[75%] rounded-2xl px-4 py-2.5"
                      style={{
                        background: msg.from === "user" ? "rgba(255,255,255,0.07)" : "rgba(251,191,36,0.15)",
                        border: msg.from === "user" ? "1px solid rgba(255,255,255,0.1)" : "1px solid rgba(251,191,36,0.25)",
                      }}>
            ...
            <div className="flex gap-2">
              <input value={input} onChange={e => setInput(e.target.value)}
                ...
                className="flex-1 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400/50"
