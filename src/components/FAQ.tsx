...
const ITEMS = [
  ...
  {
    q: "آیا امکان پرداخت مرحله‌ای یا اقساطی وجود دارد؟",
    a: "بله. مدل همکاری ماهیر به‌گونه‌ای طراحی شده که فشار مالی زیادی به شما وارد نشود. تنها بخشی از هزینه به‌عنوان پیش‌پرداخت دریافت می‌شود و باقی‌مانده به‌صورت مرحله‌ای و بر اساس رسیدن به اهداف توافق‌شده پرداخت می‌گردد. جزئیات دقیق پرداخت، متناسب با پکیج و شرایط شما، از ابتدا شفاف مشخص می‌شود.",
  },
  {
    q: "چه کسب‌وکارهایی بهترین نتیجه را از همکاری با ماهیر می‌گیرند؟",
    a: "کسب‌وکارهایی که محصول یا خدمت خوبی دارند اما در دیده‌شدن، برندینگ یا جذب مشتری ضعیف‌اند، بیشترین جهش را تجربه می‌کنند. اگر آماده‌اید در کنار ما هماهنگ و مستمر کار کنید و به بازخوردها عمل کنید، مسیر رشد بسیار سریع‌تر طی می‌شود. صنف و اندازه‌ی کسب‌وکار محدودیت نیست؛ آمادگی برای رشد مهم‌ترین عامل است.",
  },
];
