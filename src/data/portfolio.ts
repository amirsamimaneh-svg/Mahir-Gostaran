...
export type CaseStudy = {
  ...
  shortDesc: string;
  duration: string;
  /** لینک پیج اینستاگرام واقعی مشتری؛ تا وقتی خالی باشد جای‌گاه «به‌زودی» نمایش داده می‌شود. */
  instagram?: string;
  /** آیدی اینستاگرام برای نمایش (مثلاً @nila.shop) */
  instagramId?: string;
  /** لینک ویدیوی کوتاه رضایت مشتری/کیس‌استادی؛ خالی = باکس «به‌زودی». */
  clientVideo?: string;
  stats: CaseStat[];
  challenge: string;
  approach: string[];
...
export const CASES: CaseStudy[] = [
  {
    ...
    duration: "۸ هفته",
    // TODO: لینک و آیدی پیج واقعی مشتری را اینجا قرار دهید
    instagram: "",
    instagramId: "",
    stats: [
